        ...
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <div ref={drawerRef} className="absolute right-0 top-0 h-full w-64 bg-[#0B0F19] border-l border-white/[0.08] shadow-2xl animate-slide-in text-slate-200">
            ...
            <nav className="p-2 space-y-1">
              ...
              <Link href="/pricing" className="flex items-center gap-3 px-3 py-3 rounded-lg hover:bg-white/[0.03] text-sm font-semibold text-slate-300 hover:text-white" onClick={() => setOpen(false)}>
