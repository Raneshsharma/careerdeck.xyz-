...
- For each section, the SOURCE CHECK comment must list the specific facts (short phrases) you extracted from the research that are relevant to that section. If you cannot extract any relevant facts, you must state "No relevant data found" and output the "Insufficient data" message.
...
- The SOURCE CHECK comment must contain ONLY concrete, specific facts extracted from [COMPANY_RESEARCH] or [NEWS_ARTICLES]. Do NOT repeat the guiding questions. Do NOT write what the section is about. Write only facts like "Founded in 2009," "Revenue $10B in 2024," "Competitors: Adyen, PayPal." If no such facts exist, write exactly "No relevant data found."
...
- Identify the specific sentences or snippets from the provided research that contain relevant facts.
  WRONG: <!-- SOURCE CHECK for Section 1: [What the company does; primary revenue source; main customers] -->
  RIGHT: <!-- SOURCE CHECK for Section 1: Founded 2009; payment processor; revenue from transaction fees; customers are online businesses -->
- **Before writing the section content**, output a reasoning comment on its own line:
  \`<!-- SOURCE CHECK for Section X: [List the specific facts (not full sentences) you can extract from [COMPANY_RESEARCH] or [NEWS_ARTICLES] that are relevant to this section. Write each fact as a short phrase. If none exist, write "No relevant data found."] -->\`
...
- In the SOURCE CHECK comment, output ONLY the concrete, specific facts you extracted (short phrases like "Founded 2009," "58% market share"). Do NOT write the guiding questions. Do NOT write meta-descriptions. If you cannot extract any concrete fact, output "No relevant data found" and the section body must be "Insufficient data provided for this section."
