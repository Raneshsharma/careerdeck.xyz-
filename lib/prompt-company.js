...
- The SOURCE CHECK comment must contain a list of specific facts extracted from the research, not a description of the input field. Each fact should be a concise phrase. You may rephrase information in the paragraph, but every factual claim must be directly traceable to a fact listed in the SOURCE CHECK. If you cannot extract any relevant facts, write "No relevant data found."
...
- In the SOURCE CHECK comment, list the key facts (short phrases) you extracted. If no facts can be extracted, write "No relevant data found." Do not write anything else.
