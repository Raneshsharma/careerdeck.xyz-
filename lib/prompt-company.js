...
- The SOURCE CHECK comment is NOT a description of the input field. It must contain ONLY verbatim text copied from the provided research or the phrase "No relevant data found."
...
- **Before writing the section content**, output a reasoning comment on its own line:
  \`<!-- SOURCE CHECK for Section X: [COPY THE EXACT SENTENCES from [COMPANY_RESEARCH] or [NEWS_ARTICLES] that you will use to write this section. If none exist, write "No relevant data found." Do NOT write meta commentary like "THE ONLY SOURCE OF TRUTH."] -->\`
...
- In the SOURCE CHECK comment, paste the exact sentence(s) you found, verbatim. If you cannot find any, write "No relevant data found." Do not write anything else.
