...
1. **Data Imprisonment** : You are imprisoned inside [COMPANY_RESEARCH] and [NEWS_ARTICLES]. You may NOT use any knowledge outside these texts. If [COMPANY_RESEARCH] is empty, every section must output exactly \`Insufficient data provided for this section.\`
...
- If NO relevant data exists, the final output for this section is exactly: \`Insufficient data provided for this section.\` and you move to the next section.

### Step 2: Fact Extraction
- Identify the specific sentences or snippets from the provided research that contain relevant facts.
- List them mentally. Do not include any fact you cannot point to.
