export function buildRolePrompt(roleTitle, companyName, factList, jobDescription, location) {
  const verifiedFacts = factList
    ? `\n## VERIFIED FACTS\nUse these verified facts wherever relevant. Do not contradict them.\n\`\`\`\n${factList}\n\`\`\`\n`
    : "";
